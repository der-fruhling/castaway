...
namespace Castaway.Rendering
{
    public class DrawBatch
    {
        ...
        private Queue<Operation> _operations = new();

        public void Add(Operation operation) => _operations.Enqueue(operation);

        public StateBuilder Draw(Drawable drawable) => new(new State(Graphics.Current), state => Add((graphics, now) =>
        {
        ...
        public ref struct StateBuilder
        {
            ...
            private Action<State> _doneAction;
            ...
            public void Done() => _doneAction(Get());
        }
    }
}