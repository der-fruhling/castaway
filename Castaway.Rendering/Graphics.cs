...
namespace Castaway.Rendering
{
    ...
    public abstract class Graphics : IDisposable
    {
        ...
        public virtual void WindowInit(Window window) => throw new NotSupportedException();

        public virtual BufferObject NewBuffer(BufferTarget target, float[]? data = null) => throw new NotSupportedException();
        public virtual TextureObject NewTexture(int width, int height, Color color) => throw new NotSupportedException();
        public virtual TextureObject NewTexture(int width, int height, float[]? data = null) => throw new NotSupportedException();
        public virtual TextureObject NewTexture(Bitmap bitmap) => throw new NotSupportedException();
        ...
        public virtual void UnbindShader() => throw new NotSupportedException();
        public virtual void UnbindFramebuffer() => throw new NotSupportedException();

        public virtual object NativeRepresentation(RenderObject renderObject) => throw new NotSupportedException();

        public virtual void FinishFrame(Window window) => throw new NotSupportedException();
        public virtual void StartFrame() => throw new NotSupportedException();

        public virtual void Draw(ShaderObject @object, Drawable buffer) => throw new NotSupportedException();

        public virtual void SetFloatUniform(ShaderObject p, string name, float f) => throw new NotSupportedException();
        public virtual void SetFloatUniform(ShaderObject p, string name, float x, float y) => throw new NotSupportedException();
        public virtual void SetFloatUniform(ShaderObject p, string name, float x, float y, float z) => throw new NotSupportedException();
        public virtual void SetFloatUniform(ShaderObject p, string name, float x, float y, float z, float w) => throw new NotSupportedException();
        public virtual void SetIntUniform(ShaderObject p, string name, int i) => throw new NotSupportedException();
        public virtual void SetIntUniform(ShaderObject p, string name, int x, int y) => throw new NotSupportedException();
        public virtual void SetIntUniform(ShaderObject p, string name, int x, int y, int z) => throw new NotSupportedException();
        public virtual void SetIntUniform(ShaderObject p, string name, int x, int y, int z, int w) => throw new NotSupportedException();
        public virtual void SetUIntUniform(ShaderObject p, string name, uint i) => throw new NotSupportedException();
        public virtual void SetUIntUniform(ShaderObject p, string name, uint x, uint y) => throw new NotSupportedException();
        public virtual void SetUIntUniform(ShaderObject p, string name, uint x, uint y, uint z) => throw new NotSupportedException();
        public virtual void SetUIntUniform(ShaderObject p, string name, uint x, uint y, uint z, uint w) => throw new NotSupportedException();
        public virtual void SetDoubleUniform(ShaderObject p, string name, double i) => throw new NotSupportedException();
        public virtual void SetDoubleUniform(ShaderObject p, string name, double x, double y) => throw new NotSupportedException();
        public virtual void SetDoubleUniform(ShaderObject p, string name, double x, double y, double z) => throw new NotSupportedException();
        public virtual void SetDoubleUniform(ShaderObject p, string name, double x, double y, double z, double w) => throw new NotSupportedException();
        public virtual void SetFloatUniform(ShaderObject p, string name, Vector2 v) => SetFloatUniform(p, name, (float) v.X, (float) v.Y);
        public virtual void SetFloatUniform(ShaderObject p, string name, Vector3 v) => SetFloatUniform(p, name, (float) v.X, (float) v.Y, (float) v.Z);
        public virtual void SetFloatUniform(ShaderObject p, string name, Vector4 v) => SetFloatUniform(p, name, (float) v.X, (float) v.Y, (float) v.Z, (float) v.W);
        public virtual void SetFloatUniform(ShaderObject p, string name, Matrix2 m) => throw new NotSupportedException();
        public virtual void SetFloatUniform(ShaderObject p, string name, Matrix3 m) => throw new NotSupportedException();
        public virtual void SetFloatUniform(ShaderObject p, string name, Matrix4 m) => throw new NotSupportedException();
        public virtual void SetDoubleUniform(ShaderObject p, string name, Vector2 v) => SetDoubleUniform(p, name, v.X, v.Y);
        public virtual void SetDoubleUniform(ShaderObject p, string name, Vector3 v) => SetDoubleUniform(p, name, v.X, v.Y, v.Z);
        public virtual void SetDoubleUniform(ShaderObject p, string name, Vector4 v) => SetDoubleUniform(p, name, v.X, v.Y, v.Z, v.W);
        public virtual void SetDoubleUniform(ShaderObject p, string name, Matrix2 m) => throw new NotSupportedException();
        public virtual void SetDoubleUniform(ShaderObject p, string name, Matrix3 m) => throw new NotSupportedException();
        public virtual void SetDoubleUniform(ShaderObject p, string name, Matrix4 m) => throw new NotSupportedException();
        public virtual void SetIntUniform(ShaderObject p, string name, Vector2 v) => SetIntUniform(p, name, (int) v.X, (int) v.Y);
        public virtual void SetIntUniform(ShaderObject p, string name, Vector3 v) => SetIntUniform(p, name, (int) v.X, (int) v.Y, (int) v.Z);
        public virtual void SetIntUniform(ShaderObject p, string name, Vector4 v) => SetIntUniform(p, name, (int) v.X, (int) v.Y, (int) v.Z, (int) v.W);
        public virtual void SetIntUniform(ShaderObject p, string name, Matrix2 m) => throw new NotSupportedException();
        public virtual void SetIntUniform(ShaderObject p, string name, Matrix3 m) => throw new NotSupportedException();
        public virtual void SetIntUniform(ShaderObject p, string name, Matrix4 m) => throw new NotSupportedException();
        public virtual void SetUIntUniform(ShaderObject p, string name, Vector2 v) => SetUIntUniform(p, name, (uint) v.X, (uint) v.Y);
        public virtual void SetUIntUniform(ShaderObject p, string name, Vector3 v) => SetUIntUniform(p, name, (uint) v.X, (uint) v.Y, (uint) v.Z);
        public virtual void SetUIntUniform(ShaderObject p, string name, Vector4 v) => SetUIntUniform(p, name, (uint) v.X, (uint) v.Y, (uint) v.Z, (uint) v.W);
