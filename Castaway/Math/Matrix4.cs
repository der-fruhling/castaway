...
namespace Castaway.Math
{
    public struct Matrix4
    {
        ...
        public static Matrix4 operator +(Matrix4 a, Matrix4 b) => new(a.X + b.X, a.Y + b.Y, a.Z + b.Z, a.W + b.W);
        public static Matrix4 operator -(Matrix4 a, Matrix4 b) => new(a.X - b.X, a.Y - b.Y, a.Z - b.Z, a.W - b.W);
        public static Matrix4 operator *(Matrix4 a, float b) => new(a.X * b, a.Y * b, a.Z * b, a.W * b);
        public static bool operator ==(Matrix4 left, Matrix4 right) => left.Equals(right);
        public static bool operator !=(Matrix4 left, Matrix4 right) => !left.Equals(right);

        public static Vector4 operator *(Matrix4 a, Vector4 b) => new(
        ...
        public bool Equals(Matrix4 other) => X.Equals(other.X) && Y.Equals(other.Y) && Z.Equals(other.Z) && W.Equals(other.W);
